...
module.exports = {
	template: require('./tca-k1e-k1d.component.html'),
	controller: [tcaK1eK1dController],
	bindings: {
		accoridon:'&',
		data:'<'
	}
...
function tcaK1eK1dController() {
	...
	ctrl.accordionList =[
		...
		{ id:3, name: "TriNet Employment Services", isOpen: false},
		{ id:4, name: "TriNet Benefits",  isOpen: false},
		{ id:5, name: "TriNet Employee Handbook",  isOpen: false},
