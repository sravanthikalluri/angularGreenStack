...
var tnTaxesDeductionsTable = require('./tn-taxes-deductions-table.component');
...
describe('tn-hours-earnings-table component', function() {
	...
	beforeEach(function() {
		...
		var moduleName = 'trinet.shared.components.tn-taxes-deductions-table';

		angular
			.module(moduleName, [])
			.component('tnTaxesDeductionsTable', tnTaxesDeductionsTable);
	...
	beforeEach(inject(function($rootScope, $componentController) {
		...
		ctrl = $componentController('tnTaxesDeductionsTable', locals, null);
	}));
