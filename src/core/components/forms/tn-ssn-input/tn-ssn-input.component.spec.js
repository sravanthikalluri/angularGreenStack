...
var tnSsnInput = require('./tn-ssn-input.component');

describe('tn-ssn-input component', function() {
	var $scope;
	var ctrl;
	var formName={
		fieldName:{
	...
	beforeEach(function() {
		...
		angular
			.module(moduleName, [])
			.component('tnSsnInput', tnSsnInput);
	...
	beforeEach(inject(function($rootScope, $componentController) {
		...
		ctrl = $componentController('tnSsnInput', locals, null);
	}));
