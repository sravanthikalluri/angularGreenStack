...
var tnNotesInput = require('./tn-notes-input.component');

describe('tn-notes-input component', function() {
	var $scope;
	var ctrl;
	var formName={
		fieldName:{
	...
	beforeEach(function() {
		...
		angular
			.module(moduleName, [])
			.component('tnNotesInput', tnNotesInput);
	...
	beforeEach(inject(function($rootScope, $componentController) {
		...
		ctrl = $componentController('tnNotesInput', locals, null);
	}));
