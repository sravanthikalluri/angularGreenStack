...
var tnRadialProgressChart = require('./tn-radial-progress-chart.component');
...
describe('tn-profile-menu component', function () {
	...
	beforeEach(function () {
		angular
			...
			.component('tnRadialProgressChart', tnRadialProgressChart);
	...
	beforeEach(inject(function ($rootScope, _$componentController_,$state) {
		...
		obj['ctrl'] = obj['$componentController']('tnRadialProgressChart', obj.locals, null);
	}));
